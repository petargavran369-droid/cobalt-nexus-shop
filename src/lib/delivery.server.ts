...
// Waits for a real reply matching our Identifier. Chat/log broadcasts are
// ignored, and a missing/empty/error reply is treated as a failure so that
// `deliveries` never records a fake success.
