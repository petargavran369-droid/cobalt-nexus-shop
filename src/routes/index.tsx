        ...
        <div className="container-shop py-24 md:py-32 relative">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            <div className="mb-8 relative">
              <div className="absolute inset-0 -z-10 rounded-full blur-3xl opacity-50" style={{ background: "radial-gradient(circle, oklch(0.62 0.20 255 / 0.45) 0%, transparent 70%)" }} />
              <img src={logo.url} width={280} height={280} alt="Cobalt Rust EU" className="w-56 h-56 md:w-72 md:h-72 object-contain drop-shadow-[0_0_30px_oklch(0.62_0.20_255/0.6)]" />
            </div>
